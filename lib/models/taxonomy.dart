class TaxonomyModel {
  ...
  const TaxonomyModel(
      {this.id, this.taxonomy, this.description, this.parentId, this.termId});

  //const TermModel({this.id, this.name, this.slug, this.parentId, this.cntTerms});

  TaxonomyModel.fromJson(Map jsonMap)
      : id = jsonMap['id'],
        taxonomy = jsonMap['taxonomy'],
        description = jsonMap['description'],
        parentId = jsonMap['parentId'],
        termId = jsonMap['termId'];
  ...
  static List<TaxonomyModel> fromJsonList(jsonList, {dataKey: ""}) {
